...
// used to enable ctrl+shift+esc shortcut for task manager
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_60_ansi_split_space_rshift(
    F(0),     KC_1,   KC_2,   KC_3,   KC_4,     KC_5,   KC_6,     KC_7,   KC_8,     KC_9,   KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,
    KC_TAB,   KC_Q,   KC_W,   KC_E,   KC_R,     KC_T,   KC_Y,     KC_U,   KC_I,     KC_O,   KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,
    KC_ESC,   KC_A,   KC_S,   KC_D,   KC_F,     KC_G,   KC_H,     KC_J,   KC_K,     KC_L,   KC_SCLN,  KC_QUOT,  KC_ENT,
    KC_LSFT,  KC_Z,   KC_X,   KC_C,   KC_V,     KC_B,   KC_N,     KC_M,   KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,  COMPOSE,
    KC_LCTL,  KC_LGUI,KC_LALT,KC_ENT, TT(_NAV), KC_SPC, KC_RALT,  KC_APP, MO(_SET), KC_RCTL),
  ...
  [_GAME] = LAYOUT_60_ansi_split_space_rshift(
    ...
    KC_LSFT,  KC_Z,   KC_X,   KC_C,   KC_V,     KC_B,   KC_N,     KC_M,   KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  COMPOSE,
    KC_LCTL,  KC_LGUI,KC_LALT,KC_SPC, TT(_NAV), KC_SPC, KC_RALT,  KC_APP, MO(_SET), KC_RCTL),

  [_SET] = LAYOUT_60_ansi_split_space_rshift(
    ...
    KC_TRNS, KC_TRNS,   KC_TRNS,      BL_DEC,  BL_TOGG, BL_INC,  BL_BRTG, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS,   KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

  [_NAV] = LAYOUT_60_ansi_split_space_rshift(
    KC_GRV,   KC_F1,    KC_F2,    KC_F3,     KC_F4,             KC_F5,      KC_F6,    KC_F7,   KC_F8,    KC_F9,     KC_F10,     KC_F11,   KC_F12,   KC_DEL,
    ...
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   LCTL(LALT(KC_V)),  KC_MUTE,    KC_MPRV,  KC_VOLD, KC_VOLU,  KC_MNXT,   KC_MPLY,    KC_TRNS,  KC_TRNS,
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,           KC_TRNS,    KC_TRNS,  KC_TRNS, KC_TRNS,  KC_PSCREEN),
};
